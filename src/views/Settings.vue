...
const svgPricing = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>'

function navigateToApiKey() {
  router.push('/settings/apikey')
}

function navigateToModelPricing() {
  router.push('/settings/model-pricing')
}
</script>
  ...
  <div class="settings-page">
    <header class="page-header">
      <div>
        ...
        <p class="page-subtitle">管理界面主题、API 凭证与系统偏好</p>
      </div>
    </header>
    ...
    <div class="settings-list">
      ...
      <SettingRow
        :icon="svgPricing"
        title="模型定价"
        description="管理全局模型价格与各凭证自定义价"
        :navigable="true"
        @click="navigateToModelPricing"
      />
    </div>
  </div>
</template>
